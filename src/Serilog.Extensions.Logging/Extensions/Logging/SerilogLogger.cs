...
namespace Serilog.Extensions.Logging
{
    class SerilogLogger : FrameworkLogger
    {
            ...
            Func<TState, Exception, string> formatter)
        {
            ...
            if (structure != null)
            {
                if (structure.Count > 0)
                {
                    ...
                    for (int i = 0; i < structure.Count; i++)
                    {
                        ...
                        if (property.Key == SerilogLoggerProvider.OriginalFormatPropertyName &&
            ...
            if (logger.BindMessageTemplate(messageTemplate, propertyValues, out MessageTemplate parsedTemplate,
